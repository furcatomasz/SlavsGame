// File generated with Tower of Babel version: 5.3-beta on 06/21/17
    ...
    var Warrior = (function (_super) {
        ...
        function Warrior(name, scene, materialsRootDir, source) {
            ...
            if (!cloning){
                ...
                ,794,885,883,885,886,887,462,881,882,881,462,887,884,883,462,887,879], 1005);
                this.setIndices(_i);
                ...
                ,.0825,.9143,0,0,1.0025,0,0,0,.9971,0,0,0,.0775,.9135,0,0,.0878,.7875,.0949,0,.1418,.7921,.0515,0,.0648,.7371,.0927,.0768,.3019,.1168,.4704,.0656]);
                this.setVerticesData(_B.VertexBuffer.MatricesWeightsKind, _i, false);

                _i = new Float32Array(1258);
                ...
                ,27,6938,454695190,6938,27,27,27,6938,27,27,6938,1512981,1578774,421009174,437851926], 693);
                this.setVerticesData(_B.VertexBuffer.MatricesIndicesKind, UNPACK(_i), false);

                _i = new Float32Array(5032);
