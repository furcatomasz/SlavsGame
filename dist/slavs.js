...
(function (SelectCharacter) {
    var Warrior = /** @class */ (function (_super) {
        ...
        function Warrior(game, place, playerDatabase) {
            ...
            _this.mesh.skeleton.beginAnimation(AbstractCharacter.ANIMATION_STAND_WEAPON, true);
            _this.registerActions();
            return _this;
        }
        /**
    ...
    (function (Skills) {
        var Block = /** @class */ (function (_super) {
            ...
            Block.prototype.showAnimation = function (skillTime, cooldownTime) {
                ...
                setTimeout(function () {
                    game.player.runAnimationSkill('blockB', null, function () {
                        self.isInUse = false;
                    });
                }, skillTime);
            };
