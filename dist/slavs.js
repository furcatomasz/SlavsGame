            ...
            if (updatedPlayer.targetPoint) {
                ...
                activeTargetPoints[remotePlayerKey] = function () {
                    if (player.mesh.intersectsPoint(targetPointVector3_1)) {
                        ...
                        var rotation = mesh_2.rotation;
                        if (mesh_2.rotationQuaternion) {
                            rotation = mesh_2.rotationQuaternion.toEulerAngles();
                        }
                        rotation.negate();
                        ...
                        mesh_2.moveWithCollisions(forwards);
                        mesh_2.position.y = 0;
...
var Player = /** @class */ (function (_super) {
    ...
    Player.prototype.refreshCameraPosition = function () {
        ...
        this.game.getScene().activeCamera.position.y = 55;
        this.game.getScene().activeCamera.position.z -= 45;
        this.game.getScene().activeCamera.position.x -= 40;
    };
    /**
     *
...
var EnvironmentCastle = /** @class */ (function () {
    function EnvironmentCastle(game, scene) {
        ...
        plane.position.y = -3;
        plane.position.z = -4;
        var fogParticleSystem = new Particles.Fog(game, plane);
